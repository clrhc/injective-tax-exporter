// chains/zetachain.ts
// ZetaChain configuration (omnichain blockchain)
...
const NATIVE_TOKEN = {
  ...
  wrappedAddress: '0x5f0b1a82749cb4e2278ec87f8bf6b618dc71a8bf', // WZETA
};
...
const zetachain: ChainConfig = {
  ...
  transactionApi: {
    baseUrl: 'https://zetascan.com/api',
    buildUrl: (address, limit, offset) => {
      const page = Math.floor(offset / limit) + 1;
      return `https://zetascan.com/api?module=account&action=txlist&address=${address}&page=${page}&offset=${limit}&sort=desc`;
    },
  ...
  txUrl: (hash) => `https://zetascan.com/tx/${hash}`,
  addressUrl: (addr) => `https://zetascan.com/address/${addr}`,

  theme: {
    primary: '#00DC82',
    gradient: 'linear-gradient(135deg, #00DC82 0%, #00A86B 100%)',
  },
};
